...
class TwoClustersTopology( Topo ):
    ...
    def build(self, nb_of_servers, **opts):
        ...
        for srvID in range(1, nb_of_servers//2+1):
        ...
        for srvID in range(nb_of_servers//2+1, nb_of_servers+1):
            srv.append(self.addHost("server{}".format(srvID),
                                    ip=("10.1.0.{}/24".format(srvID))))
            self.addLink(sw1,
                         srv[srvID-1],
...
class Lab():
    ...
    def run(self):
        ...
        topology = TwoClustersTopology(self.nb_of_servers)
